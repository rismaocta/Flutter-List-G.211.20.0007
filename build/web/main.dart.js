...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
    ...
    build(context) {
      return new app.MaterialApp.new({home: new scaffold.Scaffold.new({body: new container.Container.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.start, children: T.JSArrayOfWidget().of([new container.Container.new({padding: new edge_insets.EdgeInsets.all(5), child: new text_field.TextField.new({controller: this.Nama, keyboardType: text_input.TextInputType.number, decoration: new input_decorator.InputDecoration.new({labelText: "Nama", border: new input_border.OutlineInputBorder.new()})})}), new container.Container.new({padding: new edge_insets.EdgeInsets.all(5), child: new text_field.TextField.new({controller: this.Umur, keyboardType: text_input.TextInputType.number, decoration: new input_decorator.InputDecoration.new({labelText: "Umur", border: new input_border.OutlineInputBorder.new()})})}), new container.Container.new({padding: new edge_insets.EdgeInsets.all(5), child: new text_field.TextField.new({controller: this.Email, keyboardType: text_input.TextInputType.number, decoration: new input_decorator.InputDecoration.new({labelText: "Email", border: new input_border.OutlineInputBorder.new()})})}), new container.Container.new({padding: new edge_insets.EdgeInsets.all(5), child: new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => {
                      ...
                      developer.inspect(this.daftarUser);
                            ...
                            let btnSimpanText = this.btnUbahText;
                            let btnSimpanWarna = this.btnUbahWarna;
                            let indexDipilih = index;
                            this.setState(dart.fn(() => {
                              btnSimpanText;
                              btnSimpanWarna;
                            }, T.VoidTovoid()));
  ...
  dart.setGetterSignature(userlist._UserListState, () => ({
    __proto__: dart.getGetters(userlist._UserListState.__proto__),
    btnUbahText: dart.dynamic,
    btnUbahWarna: dart.dynamic
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart","/zapp/project/lib/userdata.dart","/zapp/project/lib/useritem.dart","/zapp/project/lib/userlist.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;AChDoB,IAAlB,eAAO;EACT;;ECDwB;;;;;ICNf;;;;;;IACH;;;;;;IACG;;;;;;;;;;oCAEO,MAAW,MAAW;IAAtB;IAAW;IAAW;;EAAM;;;;;;;;;;;;ICAjC;;;;;;;;;;AAIwB;IAAgB;;;IAHnC;AAAd;;EAAuB;;;;;;;;;;;;;UAQG;AACxB,YAAO,uCACe,+BAAI,WACjB,6BACK,wBACR,qDAC0B,gCACjB,kBACL,AAAO,AAAS,AAAI,AAAI,iCAAH,4BACd,qCAAwB,2BAGnC,sCACsB,+BAAI,WACjB,0CACkC,yCAC7B,wBACR,kBACE,AAAO,AAAS,mCACT,0CAAiC,wBAE1C,kBAAK,AAAQ,AACuB,AACrB,UADX,AAAO,AAAS,AAAK,yCACrB,aACA,AAAO,AAAS;IAOlC;;;;;;;;EACF;;;;;;;;;;ACvCmC;IAAgB;;;;;;;;EACnD;;;;;;;;;;;;;;;;;;;;;;;;;;AAcqB;IAAI;;AAEH;IAAI;UAIE;AACxB,YAAO,gCACC,iCACE,oCACG,yCACgC,wCAC3B,wBACR,sCACsB,+BAAI,WACjB,0CACO,yBACgB,6CAChB,oDACC,gBACH,iDAId,sCACsB,+BAAI,WACjB,0CACO,yBACgB,6CAChB,oDACC,gBACH,iDAId,sCACsB,+BAAI,WACjB,0CACO,0BACgB,6CAChB,oDACC,iBACH,iDAId,sCACsB,+BAAI,WACjB,mDACM;AAEiD,sBAD1D,AAAW,sBACP,0BAAS,AAAK,gBAAU,eAAM,AAAK,iBAAO,AAAM;AAGlD,sBAFF,cAAS;AACC;;AAES,sBAAnB,kBAAQ;+CAEH,kBAAK,kBACU,uDAAuB,gBAAK,KAAK,WAG3D,+BACS,+DACW,qDACQ,uCACV,mBACC,SAAC,SAAS,UACd,sCACA,iCAAS,AAAU,uBAAC,KAAK,WACvB,iCACE,0BAAS,AAAU,uBAAC,KAAK,WACzB;AAC6B,4BAAlC,AAAK,iBAAO,AAAU,AAAQ,uBAAP,KAAK;AACiB,4BAA7C,AAAK,iBAAO,AAAU,AAAQ,AAAK,uBAAZ,KAAK;AACQ,4BAApC,AAAM,kBAAO,AAAU,AAAQ,uBAAP,KAAK;AAEzB,gDAAgB;AAChB,iDAAiB;AAEjB,+CAAe,KAAK;AAKtB,4BAHF,cAAS;AACM,8BAAb,aAAa;AACC,8BAAd,cAAc;;4DAIR,sCACU,uCAAW,aACjB,0BACP,gCACgB,uCACd,kBACC,4BACQ,gDAIC,sCACC,uCAAW,aACjB,4BACP,gCACgB,uCACd,kBACC,4BACQ,wCAIP,QAAC;AACZ,8BAAI,AAAU,SAAD,KAAqB;AACN,4BAA1B,AAAW,2BAAS,KAAK;AAIvB,4BAFF,cAAS;AACG,8BAAV;;;wEAIU,QAAC;AACf,8BAAI,AAAU,SAAD,KAAqB;AAChC,kCAAO,OAAM,uCACF,OAAO,WACP,QAAc,WACd,mFAII,wBACP,mDACe,cACG,AAAY,uBAAT,OAAO,iBAAM,gDAElC,mDACe,cACG,AAAY,uBAAT,OAAO,iBAAM;;AAO1C,kCAAO;;wBAEV,oGAGa,SAAC,SAAS,UAAU,wEAC3B,AAAW;IASxC;;;;;;IAvKsB,YAAO;IAEP,YAAO;IAEP,aAAQ;IAEf,kBAAa,0BAC1B,0BAAS,UAAU,IAAI,2BACvB,0BAAS,SAAS,IAAI;;;EAgK1B","file":"main.js"}');
  // Exports:
  return {
